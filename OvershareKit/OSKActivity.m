...
NSString * const OSKActivityOption_OrderedTypes = @"OSKActivityOption_OrderedTypes";
...
NSString * const OSKActivityType_iOS_FacebookSDK = @"OSKActivityType_iOS_FacebookSDK";
